...
export class Injest extends cdk.Stack {
    constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
        ...
        //#region ############################## Source Collection Resources ##############################
        ...
        const snsTopicsourcesValidationDLQAlertPolicyStatement = new PolicyStatement({
            ...
            conditions: {
                "StringEquals": {
                    "aws:SourceOwner": parameters.context.config.Account_ID
                }
            }
        })
        ...
        //#region ############################## Destination Publishing Resources ##############################
        ...
        new BaseCfnOutput(this,"DestinationValidationQueueUrl",{
            cfnOutputPropsName:"DestinationValidationQueueUrl",
            cfnOutputValue: destinationValidationQueue.queueUrl,
            cfnOutputExportName: ProjectName + "-" + ProjectEnvironment + "-" + ReleaseGroup + "-DestinationValidationQueueUrl",
        });

        new BaseCfnOutput(this,"DestinationValidationQueueArn",{
            cfnOutputPropsName:"DestinationValidationQueueArn",
            cfnOutputValue: destinationValidationQueue.queueArn,
            cfnOutputExportName: ProjectName + "-" + ProjectEnvironment + "-" + ReleaseGroup + "-DestinationValidationQueueArn",
        });


        new BaseCfnOutput(this,"DestinationValidationDeadLetterQueueUrl",{
            cfnOutputPropsName:"DestinationValidationDeadLetterQueueUrl",
            cfnOutputValue: destinationValidationDeadLetterQueue.queueUrl,
            cfnOutputExportName: ProjectName + "-" + ProjectEnvironment + "-" + ReleaseGroup + "-DestinationValidationDeadLetterQueueUrl",
        });

        new BaseCfnOutput(this,"DestinationTaggingQueueUrl",{
            cfnOutputPropsName:"DestinationTaggingQueueUrl",
            cfnOutputValue: destinationTaggingQueue.queueUrl,
            cfnOutputExportName: ProjectName + "-" + ProjectEnvironment + "-" + ReleaseGroup + "-DestinationTaggingQueueUrl",
        });

        new BaseCfnOutput(this,"DestinationTaggingQueueArn",{
            cfnOutputPropsName:"DestinationTaggingQueueArn",
            cfnOutputValue: destinationTaggingQueue.queueArn,
            cfnOutputExportName: ProjectName + "-" + ProjectEnvironment + "-" + ReleaseGroup + "-DestinationTaggingQueueArn",
        });

        new BaseCfnOutput(this,"DestinationTaggingDeadLetterQueueUrl",{
            cfnOutputPropsName:"DestinationTaggingDeadLetterQueueUrl",
            cfnOutputValue: destinationTaggingDeadLetterQueue.queueUrl,
            cfnOutputExportName: ProjectName + "-" + ProjectEnvironment + "-" + ReleaseGroup + "-DestinationTaggingDeadLetterQueueUrl",
        });

        new BaseCfnOutput(this,"DestinationSubmissionQueueUrl",{
            cfnOutputPropsName:"DestinationSubmissionQueueUrl",
            cfnOutputValue: destinationSubmissionQueue.queueUrl,
            cfnOutputExportName: ProjectName + "-" + ProjectEnvironment + "-" + ReleaseGroup + "-DestinationSubmissionQueueUrl",
        });

        new BaseCfnOutput(this,"DestinationSubmissionQueueArn",{
            cfnOutputPropsName:"DestinationSubmissionQueueArn",
            cfnOutputValue: destinationSubmissionQueue.queueArn,
            cfnOutputExportName: ProjectName + "-" + ProjectEnvironment + "-" + ReleaseGroup + "-DestinationSubmissionQueueArn",
        });

        new BaseCfnOutput(this,"DestinationSubmissionDeadLetterQueueUrl",{
            cfnOutputPropsName:"DestinationSubmissionDeadLetterQueueUrl",
            cfnOutputValue: destinationSubmissionDeadLetterQueue.queueUrl,
            cfnOutputExportName: ProjectName + "-" + ProjectEnvironment + "-" + ReleaseGroup + "-DestinationSubmissionDeadLetterQueueUrl",
        });

        new BaseCfnOutput(this,"sourcesValidationQueueUrl",{
            cfnOutputPropsName:"sourcesValidationQueueUrl",
            cfnOutputValue: sourcesValidationQueue.queueUrl,
            cfnOutputExportName: ProjectName + "-" + ProjectEnvironment + "-" + ReleaseGroup + "-sourcesValidationQueueUrl",
        });


        new BaseCfnOutput(this,"sourcesValidationQueueArn",{
            cfnOutputPropsName:"sourcesValidationQueueArn",
            cfnOutputValue: sourcesValidationQueue.queueArn,
            cfnOutputExportName: ProjectName + "-" + ProjectEnvironment + "-" + ReleaseGroup + "-sourcesValidationQueueArn",
        });

        new BaseCfnOutput(this,"sourcesValidationDeadLetterQueueUrl",{
            cfnOutputPropsName:"sourcesValidationDeadLetterQueueUrl",
            cfnOutputValue: sourcesValidationDeadLetterQueue.queueUrl,
            cfnOutputExportName: ProjectName + "-" + ProjectEnvironment + "-" + ReleaseGroup + "-sourcesValidationDeadLetterQueueUrl",
        });

        new BaseCfnOutput(this,"sourcesValidationTopicArn",{
            cfnOutputPropsName:"sourcesValidationTopicArn",
            cfnOutputValue: snsTopicsourcesValidation.topicArn,
            cfnOutputExportName: ProjectName + "-" + ProjectEnvironment + "-" + ReleaseGroup + "-sourcesValidationTopicArn",
        });
        //#endregion
